...
cat simulationPECmacroskeleton_curved_constant_quadratic.txt >> simulation_PEC.xmacro
cat simulationPECmacroskeleton2_curved_constant_quadratic.txt >> simulation_PEC.xmacro
